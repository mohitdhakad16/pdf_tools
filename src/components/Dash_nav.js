...
const Dash_nav = () => {
    ...
    return (
        <><nav className={`fixed top-0 z-50 w-full dark:bg-${mode === 'gray-50' ? 'gray-100' : 'gray-800'} border-b dark:border-${border} transition-all`}>
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r border-${border} sm:translate-x-0 dark:bg-${mode === 'gray-50'?'gray-100':'gray-800'} dark:border-white-700`} aria-label="Sidebar">
                    ...
                    <ul className={`pt-4 mt-4 space-y-2 font-medium border-t dark:border-${border}`}>
                        ...
                        <div className="flex relative rounded-md mx-2">
                            <div className="socialIcon cursor-pointer">
                                <img src={linkdin} alt="socail-icon" style={{ filter: `${filter}` }} />
                            </div>
                            <div className="socialIcon cursor-pointer">
                                <img src={github} alt="github" style={{ filter: `${filter}` }} />
                            </div>
                        </div>
                    </ul>
                </div>
